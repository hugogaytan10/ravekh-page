    ...
    <div className="bg-[#F8F4FF] py-16">
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between px-4 lg:px-8 xl:px-16">
        ...
        <div className="lg:w-1/2 lg:mr-8 mb-8 lg:mb-0 text-left">
          ...
          <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">Tu agenda publica digital</h2>
          <p className="text-gray-600 leading-relaxed mb-6">
            Si vendes servicios como : Veterinaria, Servicios Medicos o tu negocio maneja sus servicios por citas, ¡RAVEKH Agenda es la solución perfecta para ti!
          </p>
          <p className="font-semibold mb-4 text-lg">Con RAVEKH Agenda, tú puedes...</p>
          <ul className="list-none space-y-3">
            ...
            <li className="text-gray-700 flex items-start">
              <span className="text-[#6D01D1] font-bold mr-2">✓</span>
              Mejor administracion del tiempo.
            </li>
          </ul>
