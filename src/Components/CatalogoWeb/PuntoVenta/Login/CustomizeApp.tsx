...
export const InitialCustomizeApp: React.FC<{ navigation: any }> = ({
  ...
  return (
    <div className="customize-app-screen">
      <div
      ...
      <div className="customize-app-content flex flex-col items-center min-h-screen bg-white">
        {/* ✅ INPUTS (arriba de "Indica tu estilo") */}
        <div className="customize-app-form-section w-full flex flex-col items-center bg-white pt-6 pb-2">
          <div className="w-[90%] flex flex-col gap-3">
            <div className="flex flex-col">
              <input
                ...
                onBlur={validate}
                className="customize-app-input w-full p-3 border-b border-gray-300 rounded-md text-gray-700 bg-white"
              />
              {errors.businessName && (
        ...
        {/* Header */}
        <div className="customize-app-header w-full flex flex-col items-center bg-white py-4">
        ...
        <button
          className="customize-app-logo-btn flex items-center justify-center bg-white shadow-md rounded-lg px-4 py-2 "
        ...
        {/* Vista de muestra */}
        <div className="customize-app-preview flex justify-around items-center bg-white w-[90%] h-[350px]  rounded-lg shadow-md">
          <div className="customize-app-preview-col w-[45%] flex flex-col items-center bg-white rounded-lg shadow-sm border border-gray-200">
            {isLoading ? (
          ...
          <div className="customize-app-preview-col p-2 w-[45%] flex flex-col items-center bg-white rounded-lg shadow-sm border border-gray-200">
        ...
        {/* Botón de guardar */}
        {!isVisible && (
          <div className="customize-app-footer fixed bottom-0 bg-white w-full py-4 flex justify-center">
            <button
