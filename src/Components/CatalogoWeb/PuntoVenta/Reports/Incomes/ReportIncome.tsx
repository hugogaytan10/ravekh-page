...
export const ReportIncome: React.FC<{ navigation: any }> = ({ navigation }) => {
        ...
        return (
            <div className="p-6 bg-gray-50 min-h-screen">
                <div className="flex items-center p-4 bg-green-500 rounded-b-lg">
                    <button onClick={() => navigation.goBack()} className="mr-4">
    ...
    return (
        <div className="p-6 bg-gray-50 min-h-screen">
            ...
            <div className="mb-6">{renderSummary()}</div>
            <div className="space-y-4">{incomes.map(renderIncome)}</div>
        </div>
    );
};
