        ...
        <main className="mt-8 space-y-5">
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                <p className="text-lg font-extrabold">Nuevo cupón</p>
                <p className="text-sm text-white/80">Define el QR, vigencia y límite.</p>
              </div>
              <button
                type="button"
            ...
            <div className="mt-3 flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="mt-2 text-[11px] text-[#6a6a6a]">
                  Este código se genera automáticamente y se comparte con el cliente.
                </p>
              </div>
            </div>
          </section>
...
export { CuponesCreate };
export default CuponesCreate;
