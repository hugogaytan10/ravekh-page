  ...
  return (
    <div className="relative bg-gradient-to-b from-[#E0BBFF] to-[#F8E8FF] py-8">
      <div className="text-center mb-8">
        <p className="text-gray-600 text-sm mb-1">Desde 207 mxn/mes</p>
      ...
      <div className="flex justify-center lg:w-1/3 m-auto">
        <div className="bg-[#F0E4FF] shadow-lg rounded-lg p-6 w-full max-w-lg">
          <div className="text-gray-800 text-left text-sm leading-6">
            <p><span className="text-[#9C27B0] font-semibold">+4 hrs </span>tomando pedidos erróneos</p>
            <p><span className="text-[#9C27B0] font-semibold">+3 hrs </span>verificando inventario</p>
            <p><span className="text-[#9C27B0] font-semibold">+8 hrs </span>creando tu tienda en línea</p>
            <p><span className="text-[#9C27B0] font-semibold">+3 hrs </span>haciendo corte de caja sin errores</p>
            <p><span className="text-[#9C27B0] font-semibold">+8 hrs </span>graficando en Excel los mejores productos</p>
