      ...
      <div className=" mx-auto px-4">
        <div className="flex flex-wrap justify-between items-start">
          ...
          <div className="w-full md:w-1/4 mb-8 md:mb-0">
            <h3 className="text-3xl font-bold text-blue-600 mb-4">RAVEKH POS</h3>
          ...
          <div className="w-full md:w-1/5 mb-8 md:mb-0">
            ...
            <ul className="space-y-2">
              <li><a href="#" className="hover:underline text-gray-600">Sistema POS</a></li>
          ...
          <div className="w-full md:w-1/5 mb-8 md:mb-0">
            ...
            <ul className="space-y-2">
              <li><p className=" text-gray-600">Inventario</p></li>
              <li><p className=" text-gray-600">Reportes</p></li>
              <li><p className=" text-gray-600">RAVEKH en PC</p></li>
            </ul>
          </div>
          ...
          <div className="w-full md:w-1/5 mb-8 md:mb-0">
            ...
            <ul className="space-y-2">
              <li><p className="text-gray-600">Restaurantes</p></li>
              <li><p className="text-gray-600">Abarrotes</p></li>
              <li><p className="text-gray-600">Distribuidores</p></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-300 mt-8 pt-4 text-center">
          <p className="text-gray-500">
            © 2024 RAVEKH POS. No vendemos o compartimos tu información.
          </p>
        </div>
      </div>
    </footer>
