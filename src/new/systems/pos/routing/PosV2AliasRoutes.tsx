...
const POS_ALIASES: Array<{ from: string; to: string }> = [
  ...
  { from: POS_V2_PATHS.posBranchesAlias, to: POS_V2_PATHS.branches },
  ...
  { from: POS_V2_LEGACY_PATHS.branches, to: POS_V2_PATHS.branches },
  ...
  { from: POS_V2_LEGACY_PATHS.posBranchesAlias, to: POS_V2_PATHS.branches },
